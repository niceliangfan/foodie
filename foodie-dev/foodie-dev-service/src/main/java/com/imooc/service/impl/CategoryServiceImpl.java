...
public class CategoryServiceImpl implements CategoryService {
    ...
    public List<Category> queryAllRootLevelCat() {
        ...
        Example.Criteria categoryExampleCriteria = categoryExample.createCriteria();
        categoryExampleCriteria.andEqualTo("type", 1);
    ...
    public List<NewItemVO> getSixNewItemsLazy(Integer rootCatId) {
        ...
        List<NewItemVO> result = categoryMapperCustom.getSixNewItemsLazy(map);
        return result;
    }
}
