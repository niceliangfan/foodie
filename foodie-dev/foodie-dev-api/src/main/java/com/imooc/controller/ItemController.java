...
public class ItemController extends BaseController {
    ...
    public IMOOCJSONResult commentLevel(
        ...
        ItemCommentLevelCountsVO itemCommentLevelCountsVO = itemService.queryItemCommentLevelCounts(itemId);
        return IMOOCJSONResult.ok(itemCommentLevelCountsVO);
    }
    ...
    public IMOOCJSONResult comments(
        ...
        PagedGridResult gridResult = itemService.queryItemPagedComments(itemId, level, page, pageSize);
    ...
    public IMOOCJSONResult search(
        ...
        PagedGridResult gridResult = itemService.searchPagedItems(keywords, sort, page, pageSize);
    ...
    public IMOOCJSONResult catItems(
        ...
        PagedGridResult gridResult = itemService.searchPagedItemsByThirdCatId(catId, sort, page, pageSize);
    ...
    public IMOOCJSONResult refresh(
        ...
        List<ShopCartItemVO> list = itemService.queryItemsBySpecIds(itemSpecIds);
